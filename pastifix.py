...
line = LINE("EEmzP45aN6SW0Nvelit3.qxR6qp9lW4DbdlW1mC5OuW.mESJLts5toz3wX0rbWwqZ/QivofiVvUkQiuckNgdSq8=")
line.log("Auth Token : " + str(line.authToken))
line.log("Timeline Token : " + str(line.tl.channelAccessToken))

ki = LINE("EENNJhm618VgFOrBDxPd.3/PYls6PbTe/75uJrezv+q.PCaZX0GhRlIJLkRCOx/uDpY+sOyQDWhmU1zLVsEQUWo=")
ki.log("Auth Token : " + str(line.authToken))
ki.log("Timeline Token : " + str(line.tl.channelAccessToken))

ki2 = LINE("EE1BC0bjhn1ZCuFI2Bw7.eLDo455gnmVoC175GjR4TW.NiQjZLAofg2rgpk07/T+vwB7ixdxV+6RT4V7529UvKI=")
ki2.log("Auth Token : " + str(line.authToken))
ki2.log("Timeline Token : " + str(line.tl.channelAccessToken))

ki3 = LINE("EEc7zOxxUe2DVBfg6dof.aC3os7cz/sXqz9zOJq2vNW.TuvdTmUKQiFLJkN3YDYeg5MWQnq2ZXflKch7NVKENIQ=")
